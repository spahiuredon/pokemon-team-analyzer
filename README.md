...
Erwartete Ausgabe: `Ran 35 tests in 0.00Xs - OK`.
...
| `tests/`               | 35 Unit-Tests, decken jede Klasse ab. Der API-Client wird mit `unittest.mock` getestet, damit keine echten Netzwerk-Aufrufe nötig sind. |
